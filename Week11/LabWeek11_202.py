...
def print_total_from_pounds(pounds):
...
while True:
    ...
    usr_input = input("How many pounds of coffee do you want to order? ")
    if (usr_input == "quit"):
        break
    print_total_from_pounds(int(usr_input))
